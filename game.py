...
class Game:
    ...
    def get_computer_valid_and_allowed_move(self, color):
        ...
        result = self.game_table.get_all_allowed_moves(color)
        print("////////////////////////////////////////////////////////")
        print("////////////////////////////////////////////////////////")
        print("////////////////////////////////////////////////////////")
        for mv in range(0, 3):
            game = deepcopy(self)
            game.game_table.play_move(result[mv])
            game.game_table.print_table()
            print("////////////////////////////////////////////////////////")
            
        # list(map(lambda el: print(el), result))
        return result[0]# self.get_human_valid_and_allowed_move(color)
